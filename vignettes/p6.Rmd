...
[https://www.r-inla.org/download/](https://www.r-inla.org/download/)
...
* `title_has_excl`, whether or not the article contains an exclamation mark (values `TRUE` or `FALSE`);
...
```{r eval=FALSE}
model1 <- bayesx(formula = y ~ x1 + x2 + x3 + sx(w, bs = "offset"),
                 data = data.set,
                 family="poisson")
```
