...
set manually to provide a sensible, smooth curve.
...
do you think that these differences appear?
    ...
    ```{r fig = TRUE}
    plot(density(theta_sim, weights = ww, bw = 0.025), main = "Posterior density")
    ```
...
mayfly size - the data come from the book *Statistics for Ecologists Using R and Excel 2nd edition* by Mark Gardener (ISBN 9781784271398), see [the publisher's webpage](https://pelagicpublishing.com/products/statistics-for-ecologists-using-r-and-excel-gardener-2nd-edition).
