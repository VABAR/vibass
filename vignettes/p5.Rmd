...
* Use IS to compute and plot the weights using this non-conjugate distribution, using them to estimate the posterior mean and variance. Finally, show the posterior density estimate.
...
* Use MH to produce the posterior density estimate.
